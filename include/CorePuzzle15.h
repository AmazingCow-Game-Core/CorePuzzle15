...
#ifndef __CorePuzzle15_include_CorePuzzle15_h__
#define __CorePuzzle15_include_CorePuzzle15_h__

//This is a umbrella header indented to ease the inclusion of all files
//needed to use the Puzzle15 Game Core.
...
#endif // defined(__CorePuzzle15_include_CorePuzzle15_h__) //
